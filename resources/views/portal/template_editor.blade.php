...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl p-4">
        <form id="temp_form_data_up" action="{{Route('template-edit')}}" method="post">
            @csrf
            <div class="mb-2">
                <label for="name" class="font-medium text-sm text-slate-600 dark:text-slate-400">Nom du template</label>
                <input class="hidden" type="text" name="id" value="{{$templ->id}}">
            ...
            <div class="mt-5 flex justify-end items-center gap-x-2 py-3 px-4">
                ...
                <button type="button" data-hs-overlay="#hs-bg-preview" onclick="showPreview(document.getElementById('content-{{$templ->id}}').value);" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-gray-200 bg-gray-100 text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" data-hs-overlay="#hs-notifications">
                    Voir le rendu
                </button>
                <button type="submit" id="btn_update" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-blue-600 text-white hover:bg-blue-600 focus:outline-none focus:bg-blue-600 disabled:opacity-50 disabled:pointer-events-none">
                    Enregistré
                </button>
            </div>
        </form>
